...
### Analizando y debuggeando tu plataforma, Luis Bosque (@luisico), CartoDB
...
Saber cómo se comportan tus usuarios

Saber como afectan los cambios que haces

No valen sensaciones
...
- no visualizaciones de su app
- widgets más usados

Herramientas análisis logs : logstash, fluentd, splunk, syslog

No volverte loco con las métricas, qué precisión quieres (queries de mas de 30seg), retención de

datos (no todas las métricas tienen el mismo ciclo de vida)

Impacto técnico muy grande, ten cuidado
...
spread operator : convierte varios argumentos en un array

default parameters

arrow functions

Librería ESNext para usar ES6 hoy
